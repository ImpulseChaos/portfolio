...
export default function Contact() {
  return (
    <section id="contact" className="py-24 px-6 bg-white dark:bg-slate-800/50">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="max-w-xl">
          <p className="text-slate-600 dark:text-slate-400 mb-8 leading-relaxed">
            ...
            question, a job offer, or just want to say hi — feel free to reach
            out!
          </p>
          ...
          <div className="space-y-3">
            {contactLinks.map((link) => (
              <a
                ...
                className="flex items-center gap-4 p-4 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-lg hover:border-indigo-500 dark:hover:border-indigo-500 text-slate-700 dark:text-slate-300 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors"
              >
